...
class R {
  ...
  static const String demoSubscriptionPayment = '/demo-subscription-payment';
  ...
  static const String wsAdminChat = '/ws/admin-chat';
  ...
  static const String saWorkshopChat = '/admin/workshop-chat';
  static const String saDocuments = '/admin/documents';
  static const String saDriverChat = '/admin/driver-chat';
  static const String saEmergency = '/admin/emergency';
  static const String saDiagnostics = '/admin/diagnostics';
}
