                        ...
                        children: [
                          ...
                          _miniButton(
                            ...
                            onTap: workshop.isVerified
                                ...
                                : () => AppErrorHandler.guard<void>(
                                      ...
                                      fallbackMessage: 'Could not verify this workshop right now.',
                                    ),
                          ),
                          _miniButton(
                            ...
                            onTap: () => AppErrorHandler.guard<void>(
                              ...
                              () async {
                                await _service.updateWorkshop(
                                  id: workshop.id,
                                  status: workshop.status == AdminAccountStatus.suspended
                          ...
                          _miniButton(
                            ...
                            onTap: () => AppErrorHandler.guard<void>(
                              ...
                              fallbackMessage: 'Could not delete this workshop right now.',
                            ),
                          ),
                        ],
                      ),
