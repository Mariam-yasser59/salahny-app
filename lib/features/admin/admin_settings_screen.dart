...
class AdminSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      const AdminShell(title: 'Admin Settings', child: AdminSettingsView());
}
...
class _AdminSettingsViewState extends State<AdminSettingsView> {
  ...
  bool _notificationsEnabled = AppCache.adminSettings.notificationsEnabled;

  @override
  void initState() {
    super.initState();
    final settings = AppCache.adminSettings;
    ...
    _announcementTitleCtrl = TextEditingController(
      text: settings.announcementTitle,
    );
    _announcementBodyCtrl = TextEditingController(
      text: settings.announcementBody,
    );
    _load();
  }
                ...
                AppBtn(
                  ...
                  onTap: () async {
                    ...
                    final ok = await AppErrorHandler.guard<bool>(
                      ...
                      fallbackMessage:
                          'Could not save admin settings right now.',
                    );
