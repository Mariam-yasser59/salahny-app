  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [const Color(0xFF7C3AED).withOpacity(0.2), AC.s2],
      ),
      borderRadius: Rd.lgA,
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          const Text('Supports .csv and .json OBD log formats', style: TextStyle(fontSize: 12, color: AC.t3), textAlign: TextAlign.center),
        ],
      ),
    ),
  );
...
class _ManualPanel extends StatelessWidget {
  final TextEditingController rpm, coolant, speed, voltage, runTime,
      engineLoad, throttle, timingAdvance, stFuelTrim, ltFuelTrim,
      fuelTank, fuelAirRatio, intakeManifoldPressure, intakeAirTemp,
      barometricPressure, absThrottleB, relThrottlePos, pedalD, pedalE,
      commandedThrottle, catTempS1, catTempS2, evapPurge, faultCodes;
  ...
  const _ManualPanel({
    ...
    required this.throttle, required this.timingAdvance, required this.stFuelTrim,
    required this.ltFuelTrim, required this.fuelTank, required this.fuelAirRatio,
    ...
    required this.evapPurge, required this.faultCodes,
  });
  ...
  Widget build(BuildContext context) => WsCard(
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('OBD-II INPUTS', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: AC.t3, letterSpacing: 1)),
        const SizedBox(height: 16),

        // Required
        _GroupLabel(label: 'Required', color: AC.error),
        ...
        // Engine
        _GroupLabel(label: 'Engine', color: AC.warning),
        const SizedBox(height: 10),
        Row(children: [
        ...
        // Fuel System
        _GroupLabel(label: 'Fuel System', color: AC.gold),
        const SizedBox(height: 10),
        Row(children: [
        ...
        // Air & Pressure
        _GroupLabel(label: 'Air & Pressure', color: AC.info),
        const SizedBox(height: 10),
        Row(children: [
        ...
        // Throttle & Pedal
        _GroupLabel(label: 'Throttle & Pedal', color: AC.success),
        const SizedBox(height: 10),
        Row(children: [
        ...
        // Catalyst
        _GroupLabel(label: 'Catalyst Temperature', color: AC.error),
        const SizedBox(height: 10),
        Row(children: [
        ...
        // Evaporative
        _GroupLabel(label: 'Evaporative System', color: AC.success),
        const SizedBox(height: 10),
        _Field('Commanded Evaporative Purge', 'e.g. 50', '%', evapPurge),
        const SizedBox(height: 16),

        // DTC Fault Codes
        _GroupLabel(label: 'DTC Fault Codes', color: AC.error),
        const SizedBox(height: 6),
        const Text(
          'Enter codes from your OBD scanner, separated by commas. Each code will be looked up and defined automatically.',
          style: TextStyle(fontSize: 11, color: AC.t3, height: 1.5),
        ),
        const SizedBox(height: 10),
        _Field('Fault Codes (optional)', 'P0300, P0420, U0100', '', faultCodes, optional: true),
      ],
    ),
  );
}
  ...
  Widget build(BuildContext context) => Center(
    child: Column(
      children: [
                  ...
                  children: List.generate(3, (i) {
                    ...
                    return Transform.scale(
                      ...
                      child: Opacity(
                        ...
                        child: Container(
                          width: 160, height: 160,
                          decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: AC.red, width: 1.5)),
                        ),
                      ),
                    );
                  }),
        ...
        const Text('Analyzing Vehicle Data…', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AC.red)),
        const SizedBox(height: 6),
