...
class _WsDiagnosticsScreenState extends State<WsDiagnosticsScreen>
  ...
  void initState() {
    ...
    _speedCtrl = TextEditingController(text: vital('Speed', ''));
  ...
  Map<String, double> _buildSensorReadings() {
    return {
      ...
      'VEHICLE_SPEED': double.tryParse(_speedCtrl.text.trim()) ?? 0,
      ...
      return GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: Rd.lgA,
            border: Border.all(
              color: sel ? s.color.withOpacity(0.5) : AC.border,
              width: sel ? 1.2 : 0.8,
            ),
            boxShadow: sel
                ? [BoxShadow(color: s.color.withOpacity(0.2), blurRadius: 14)]
                : null,
          ),
          child: Row(
            children: [
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            'Supports .csv, .json, .txt OBD log formats',
...
class _ManualPanel extends StatelessWidget {
  final TextEditingController rpmCtrl,
      tempCtrl,
      mapCtrl,
      speedCtrl,
      mafCtrl,
      ...
      codesCtrl;
  const _ManualPanel({
    required this.rpmCtrl,
    required this.tempCtrl,
    required this.mapCtrl,
    required this.speedCtrl,
    required this.mafCtrl,
    required this.o2Ctrl,
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(child: _Field('Speed (km/h)', 'e.g. 32', speedCtrl)),
          ],
        ),
        const SizedBox(height: 12),
        Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(child: _Field('O2 Voltage (V)', 'e.g. 0.45', o2Ctrl)),
          ],
        ),
        const SizedBox(height: 12),
  ...
  Widget build(BuildContext context) => Center(
    child: Column(
      children: [
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  shape: BoxShape.circle,
                  boxShadow: [
                    BoxShadow(color: AC.red.withOpacity(0.55), blurRadius: 30),
                  ],
                ),
        ...
        const SizedBox(height: 6),
        const Text(
          'AI model is processing sensor readings',
          style: TextStyle(fontSize: 12, color: AC.t3),
        ),
        const SizedBox(height: 24),
      ],
