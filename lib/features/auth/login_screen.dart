...
import '../driver/profile/services/user_service.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  bool get _isAdminEmail =>
      _email.text.trim().toLowerCase() == AppCache.superAdmin.email;
  ...
  Future<void> _login() async {
    ...
    final role = await AppErrorHandler.guard<String?>(context, () async {
      final selectedRole = await AppCache.getRole();

      final response = await _auth.login(
        email: _email.text.trim(),
        password: _pass.text,
        expectedRole: selectedRole == 'guest' ? null : selectedRole,
      );
      ...
      if (user != null) {
        ...
        unawaited(_userService.getMe().catchError((_) => <String, dynamic>{}));
      }
  ...
  Future<void> _googleLogin() async {
    ...
    final role = await AppErrorHandler.guard<String?>(context, () async {
      final response = await _googleAuth.signIn();
      final user = response['user'] as Map<String, dynamic>?;
      ...
      return user?['role']?.toString() ?? 'driver';
    }, fallbackMessage: 'Could not sign you in with Google.');
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [AC.red.withOpacity(0.22), Colors.transparent],
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppBtn(
                      label: GoogleAuthService.isConfigured
                      ...
                      onTap: _loading || !GoogleAuthService.isConfigured
                          ? null
                          : _googleLogin,
