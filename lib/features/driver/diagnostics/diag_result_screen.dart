  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: SAppBar(
        ...
        actions: [_BarAction(Icons.share_outlined, () {})],
      ),
            ...
            if (report.faultCodes.isNotEmpty) ...[
              ...
              ...report.faultCodes.asMap().entries.map(
                (e) => Padding(
                  ...
                  child: _FaultCodeTile(code: e.value).animate().fadeIn(
                    duration: 350.ms,
                    ...
                    .map<Widget>(
                      (e) => Padding(
                        padding: EdgeInsets.only(
                          bottom: e.key < report.recommendations.length - 1
                              ? 12
                              : 0,
                        ),
                        child: Row(
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [_riskColor.withValues(alpha: 0.18), AC.s2, AC.s1],
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      CustomPaint(
        ...
        child: const SizedBox(width: 110, height: 60),
      ),
      ...
      children: [
        ...
        Row(
          children: [
            _MiniInfo(
              title: 'Fault',
              value: ai.hasFault ? 'Detected' : 'None',
              color: ai.hasFault ? AC.error : AC.success,
            ),
        ...
        if (ai.explanation.isNotEmpty) ...[
          ...
          Text(
            ai.explanation,
            style: const TextStyle(fontSize: 13, color: AC.t2, height: 1.55),
          ),
        ],
        const SizedBox(height: 14),
        Text(
      ...
      return ACard(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              v.unit,
              style: TextStyle(fontSize: 10, color: col.withValues(alpha: 0.7)),
            ),
            const SizedBox(height: 8),
            Text(
              v.key,
...
class _FaultCodeTile extends StatelessWidget {
  ...
  String get _severityLabel => code.severity.toUpperCase();
