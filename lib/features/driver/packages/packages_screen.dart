            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: Rd.lgA,
                  boxShadow: [
                    BoxShadow(color: AC.red.withOpacity(0.4), blurRadius: 24),
                  ],
                ),
                child: Column(
                  children: const [
  ...
  Widget build(BuildContext context) => Container(
        decoration: BoxDecoration(
          gradient: pkg.isPopular
              ? LinearGradient(
                  colors: [AC.redDark.withOpacity(0.35), AC.bg],
                )
              : null,
          ...
          boxShadow: pkg.isPopular
              ? [BoxShadow(color: AC.red.withOpacity(0.2), blurRadius: 22)]
              : null,
        ),
        child: Padding(
                  ...
                  if (pkg.originalPrice > pkg.price)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: AC.success.withOpacity(0.3),
                        ),
                      ),
                      child: Text(
