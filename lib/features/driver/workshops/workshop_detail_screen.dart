  ...
  Widget build(BuildContext context) {
    ...
    if (workshops.isEmpty) {
      return Scaffold(
        ...
        appBar: SAppBar(title: 'Workshop Details'),
        body: const Center(
          child: EmptyState(
            icon: '🏢',
            title: 'No Workshop Found',
            sub: 'Workshop details will appear after owner setup.',
          ),
        ),
      );
    }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  if (ws.latitude != null && ws.longitude != null) ...[
...
class _CRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
    children: [
      ...
      Expanded(
        child: Text(text, style: const TextStyle(fontSize: 13, color: AC.t2)),
      ),
    ],
  );
}
