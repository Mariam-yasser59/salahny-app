  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: IndexedStack(
      ...
      children: [
        ...
        AppCache.isGuest ? const _GuestPrompt() : const _ProfileTab(),
      ],
    ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 4),
                                      Text(
                                        '${vehicles.length} vehicle${vehicles.length == 1 ? '' : 's'} on account',
                                        style: const TextStyle(
                                          fontSize: 12,
  ...
  Widget build(BuildContext context) => Center(
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          const Icon(Icons.lock_outline_rounded, size: 42, color: AC.red),
          const SizedBox(height: 14),
          const Text(
          ...
          Row(
            children: [
              Expanded(
                child: AppBtn(
                  label: 'Login',
                  onTap: () => Navigator.pushNamed(context, R.login),
                ),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    if (bookings.isEmpty) {
      return ACard(
        ...
        child: Column(
          children: [
            const Icon(Icons.calendar_month_rounded, color: AC.t3, size: 34),
            const SizedBox(height: 10),
            const Text(
              'No Active Booking',
              style: TextStyle(
    ...
    return ACard(
      ...
      child: Column(
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: Rd.mdA,
                  boxShadow: [
                    BoxShadow(color: AC.red.withOpacity(0.35), blurRadius: 14),
                  ],
                ),
                child: const Icon(
                  Icons.build_rounded,
          ...
          Row(
            children: [
              _Chip(Icons.calendar_today_rounded, b.date),
              const SizedBox(width: 14),
          ...
          AppBtn(
            ...
            small: true,
            onTap: () =>
                Navigator.pushNamed(context, R.bookingTrack, arguments: b.id),
            icon: const Icon(
          ...
          children: [
            Row(
              children: [
                ...
                const Spacer(),
                if (w.isVerified)
                  const GoldBadge('Verified', icon: Icons.verified_rounded),
              ],
            ),
            ...
            Row(
              children: [
                ...
                const Spacer(),
                const Icon(Icons.location_on_rounded, size: 12, color: AC.t3),
                Text(
                  '${w.distance} mi',
                  style: const TextStyle(fontSize: 11, color: AC.t3),
                ),
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: Rd.lgA,
        border: Border.all(color: const Color(0xFF4C2D8A).withOpacity(0.45)),
      ),
      child: Row(
        children: [
          Container(
          ...
          const Icon(Icons.arrow_forward_ios_rounded, color: AC.t3, size: 14),
        ],
      ),
    ),
  );
...
class _ServiceCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => GestureDetector(
    onTap: () => Navigator.pushNamed(context, R.bookService, arguments: svc.id),
    child: ACard(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: Rd.mdA,
                  boxShadow: [
                    BoxShadow(color: AC.red.withOpacity(0.3), blurRadius: 14),
                  ],
                ),
                child: Center(
                  child: Text(svc.emoji, style: const TextStyle(fontSize: 22)),
                ),
              ),
...
class _DiagnosticsTabState extends State<_DiagnosticsTab>
  ...
  Future<void> _startScan() async {
    ...
    if (mounted) {
      ...
      _scan.stop();
      _scan.reset();
      Navigator.pushNamed(context, R.diagnostics);
    }
  }
              ...
              AnimatedBuilder(
                ...
                builder: (_, __) => Stack(
                  ...
                  children: [
                    ...List.generate(3, (i) {
                      final delay = i * 0.33;
                      final prog = (_scan.value - delay).clamp(0.0, 1.0);
...
class _BookingTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ACard(
    padding: const EdgeInsets.all(16),
    onTap: () => Navigator.pushNamed(context, R.bookingTrack, arguments: b.id),
    child: Column(
      children: [
        Row(
          children: [
...
class _NavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: AC.s1,
      border: const Border(top: BorderSide(color: AC.border, width: 0.5)),
      boxShadow: [
        BoxShadow(
