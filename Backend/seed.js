...
const ServicePackage = require('./src/models/ServicePackage.js');
const Admin = require('./src/models/Admin.js');
const DriverProfile = require('./src/models/DriverProfile.js');

const MONGO_URI =
  process.env.MONGO_URI || 'mongodb://localhost:27017/salahny';
...
async function seed() {
  ...
  await Service.insertMany([
    ...
    },
    {
      ...
      description: 'Full OBD-II scan with AI analysis',
      price: 200,
      durationMins: 60,
      isPopular: true,
    },
    ...
    },
    {
      name: 'AC Service',
      category: 'Comfort',
      description: 'AC recharge and leak check',
      price: 250,
      durationMins: 60,
      isPopular: false,
    },
    {
      name: 'Battery Check',
      category: 'Electrical',
      description: 'Battery load test and terminal clean',
      price: 100,
      durationMins: 30,
      isPopular: true,
    },
